                    ...
                    Padding(
                      ...
                      child:Column(
                       ...
                       children: [
                        ...
                        Padding(
                          padding:EdgeInsets.all(2),child:  Text('${diets[index].name}\n ${diets[index].level} | ${diets[index].duration} | ${diets[index].calorie}',style: TextStyle(
                            fontWeight: FontWeight.bold
                          ),
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ListView.separated(
                        ...
                        separatorBuilder: (ctx,index)=>SizedBox(height:13),
